...
def benfords_law_test(df, column):
    ...
    # Second position
    observed_values_2 = df[column].astype(str).str[:2].value_counts().astype(int).sort_values()
    ...
    # Third position
    observed_values_3 = df[column].astype(str).str[:3].value_counts().astype(int).sort_values()
