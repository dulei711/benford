...
def benfords_law_test(df, column):
    ...
    # Second position
    observed_values_2 = df[column].astype(str).str[:2].value_counts().sort_index().sort_values()
    ...
    # Third position
    observed_values_3 = df[column].astype(str).str[:3].value_counts().sort_index().sort_values()
