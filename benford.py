...
def benfords_law_test(df, column):
    ...
    axs[0].bar(expected_values_1.index, expected_values_1.values / len(df[column]), 'ro-', label='Expected')
    ...
    axs[1].bar(expected_values_2.index, expected_values_2.values / len(df[column]), 'ro-', label='Expected')
    ...
    axs[2].bar(expected_values_3.index, expected_values_3.values / len(df[column]), 'ro-', label='Expected')
